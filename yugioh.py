...
print("  3. Each player's board has 3 monster zones, 3 spell and trap zones, a deck zone, a field spell zone, and graveyard, and a banished zone\n")
...
print("  5. You can change the battle position of each monster max 1 time per turn. Defense positions must go to attack and attack must go to face-up defense\n")
